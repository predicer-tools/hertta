...
pub fn update_outside_inflow(building_data: &mut BuildingData, outside_inflow: Vec<TimeSeries>) {
    if let Some(outside_node) = building_data.input_data.nodes.get_mut("outside") {
